...
$( document ).ready(function() {
  ...
  // Busco la lista de productos y la muestro 
  buscarListaDeProductos();

  // Ejecuto cada 1 seg (1000 ms) la funcion que refresca la lista de productos
  setInterval( buscarListaDeProductos ,1000 );
